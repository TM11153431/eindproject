	...
	svg.selectAll('.line')
        ...
        .on('mouseover', function(d) { 
        	...
        	if (d[0].type == "Withdraw") {
        		tooltip.text("Withdrawing")
        		return tooltip.style("visibility", "visible");
        	}
        	if (d[0].type == "America") {
        		tooltip.text("America: produced 22% of the global emissions and has to reduce 2.96 gigations of CO2 in 2030")
        		highlight("America");
        		return tooltip.style("visibility", "visible");
        	}
        	if (d[0].type == "Europa") {
        		tooltip.text("Europe: produced 11% of the global emissions and has to reduce 1.4 gigations of CO2 in 2030")
        		highlight("Europa");
        		return tooltip.style("visibility", "visible");
        	}
        	if (d[0].type == "China") {
        		tooltip.text("China: produced 26% of the global emissions and has to reduce 3.45 gigations of CO2 in 2030")
        		highlight("China");
        		return tooltip.style("visibility", "visible");
        	}
        	if (d[0].type == "Developed countries") {
        		tooltip.text("Developed countries: produces 18% of the global emissions and has to reduce 2.45 gigations of CO2 in 2030")
        		highlight("Developed countries");
        		return tooltip.style("visibility", "visible");
        	}
        	if (d[0].type == "Developing countries") {
        		tooltip.text("Developing countries: produces 23% of the global emissions and has to reduce 3.04 gigations of CO2 in 2030")
