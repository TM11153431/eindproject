...
function scatterplot(onBrush, section) {
    ...
    return function update(data) {
        x.domain(d3.extent(data, function (d) { console.log(d[section]);  return d[section]}))
        y.domain(d3.extent(data, function (d) { console.log(d.renewables); return d.renewables }))
