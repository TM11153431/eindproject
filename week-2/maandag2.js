...
function initialize(error, results) {
	...
	var components = [ choropleth(features, data), scatterplot(onBrush, data) ]
...
//function filterXas(data, foo) {
//  	var Xas = {};
//  	data.forEach(function(d){ Xas[d.Land] = +d.foo })
//  		
//  	return Xas;
//}  	
...
function scatterplot(onBrush, data) {

	//var belle = filterXas(data)
	//console.log(belle)
  ...
  // });
    ...
    return function update(data) {
        x.domain(d3.extent(data, function (d) { return d.LifeEx })).nice()
